...
MODEL_CONFIG = {
    "coding": {
        ...
        "template": (
            ...
            "coding solutions and explanations. Answer in the language of the user's input.\n\n"
    ...
    "instruction": {
        ...
        "template": (
            ...
            "detailed explanations for instructive or evaluative queries. Answer in the language of the user's input. Keep the responses short and concise.\n\n"
            "Chat history: {chat_history}\n\nUser question: {user_question}"
        ),
        "data_collection": "deny"
    },
    "conversation": {
        "model_name": "microsoft/phi-4:online",  # Replace with the actual Phi model name
        "api_key": Gemini,
        "plugins": [
            {
                "id": "web",
    ...
    "web-search": {
        ...
        "template": (
            "You are an academic expert with broad knowledge. Provide well-reasoned, accurate answers "
            "If you don't know the answer state it clearly. Answer in the language of the user's input.\n\n"
            "Chat history: {chat_history}\n\nUser question: {user_question}"
        ),
        "data_collection": "deny"
    },
